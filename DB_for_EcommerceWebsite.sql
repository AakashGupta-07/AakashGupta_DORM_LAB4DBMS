-- Here is An E-commerce Website Which manages its data in the form of various tables.
-- 1)We are required to create tables for supplier,customer,category,product,supplier_pricing,order,rating to store the data for the E-commerce Website with the schema definition given below.
...
-- 2). Insert the following Values in the table created above
